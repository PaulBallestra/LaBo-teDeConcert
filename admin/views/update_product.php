...
<section>
    ...
    <form action="index.php?page=products&action=updated&id=<?= $product['id'] ?>" method="post" enctype="multipart/form-data">
        ...
        <section class="sectionInput">
            ...
            <input id="productQuantity" type="number" name="productQuantity" class="inputForm" value="<?= isset($_SESSION['old_inputs']) ? $_SESSION['old_inputs']['productQuantity'] : $product['quantity'] ?>" required>
        </section>
        ...
        <section class="sectionImages">
            ...
            <div class="sectionInput inputImage">
                ...
                <input type="file" name="productImage1" id="productImage1" accept=".gif, .png, .jpg, .jpeg" width="800" height="600">
            ...
            <div class="sectionInput inputImage">
                ...
                <input type="file" name="productImage2" id="productImage2" accept=".gif, .png, .jpg, .jpeg" width="800" height="600">
            ...
            <div class="sectionInput inputImage">
                ...
                <input type="file" name="productImage3" id="productImage3" accept=".gif, .png, .jpg, .jpeg" width="800" height="600">
