        ...
        <div class="divProfilContent">
            ...
            <div class="divInfosContent">
                ...
                <div class="divButtonsInfos">
                    <a href="index.php?page=profil&action=update&id=<?=$_SESSION['user']['id']?>"><input type="submit" value="Modifier mon compte" class="btnSubmit"></a>
                    <input type="submit" value="Supprimer mon compte" class="btnSubmit">
                </div>
