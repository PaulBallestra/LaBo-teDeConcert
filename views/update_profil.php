        ...
        <div class="divUpdateProfil">
            ...
            <form action="index.php?page=profile&action=update_profile" method="post">
                ...
                <section class="sectionInput">
                    ...
                    <input id="phone" type="tel" name="phone" pattern="[0-9]{10}" class="inputForm" value="<?= isset($_SESSION['old_inputs']['address']) ? $_SESSION['old_inputs']['phone'] : (isset($_SESSION['user']) ? $_SESSION['user']['phone'] : '') ?>">
                </section>
